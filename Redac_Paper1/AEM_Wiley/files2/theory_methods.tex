...
\begin{align}
    \text{PCE}_{\rm est} &> \SI{15}{\percent}, \\
    \text{Average Transmission}_{\numrange{400}{700}\,\text{\nano\meter}} &> \SI{40}{\percent}, \\
    \Delta E_{\rm LUMO} &> \SI{0.3}{\electronvolt}, \\
    \mu_{\rm est} &> \SI{e-4}{\centi\meter\squared\per\volt\per\second}, \\
    B_{\rm index} &> \num{80}~\text{(biodegradability)}, \\
    T_{80, \rm est} &> \SI{10000}{\hour}.
\end{align}
