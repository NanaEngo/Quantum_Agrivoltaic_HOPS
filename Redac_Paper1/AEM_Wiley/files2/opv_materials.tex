...
The thin Ag top electrode can provide \SI{72}{\percent} average transmittance in the \SIrange{700}{850}{\nano\meter} range while maintaining sheet resistance below \SI{15}{\ohm\per\square}. Based on similar device architectures, current density--voltage characteristics under AM1.5G illumination (\SI{100}{\milli\watt\per\centi\meter\squared}) are expected to yield:
\begin{itemize}
